<template>
  <div>
    ...
    <i-button @click="handleClick" inline="true">行内按钮</i-button>
    <i-button @click="handleClick" inline="true" type="primary">行内按钮</i-button>
    <i-button @click="handleClick" inline="true" type="success">行内按钮</i-button>
    ...
    <i-button @click="handleClick" type="primary" disabled="true">禁用按钮</i-button>
  </div>
</template>
<script>
